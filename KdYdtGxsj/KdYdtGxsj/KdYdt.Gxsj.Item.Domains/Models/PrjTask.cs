...
namespace KdYdt.Gxsj.Item.Domains.Models
{
    ...
    /// 任务安排
    /// </summary>
    public class PrjTask : BaseProject
    {
        /// <summary>
        /// 任务是否已确认下达
        /// </summary>
        ...
        //[NotMapped]
        //[XmlIgnore]
        //public virtual PrjItem Project { get; set; }
